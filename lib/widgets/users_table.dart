              ...
              child: widget.isLoading
                  ...
                  : _currentPageUsers.isEmpty
                      ...
                      : SingleChildScrollView(
                          child: Column(
                            children: _currentPageUsers.asMap().entries.map((entry) {
                ...
                return DecoratedBox(
                  decoration: BoxDecoration(
                    border:
                        !isLast ? Border(bottom: BorderSide(color: colors.borderColor.withValues(alpha: 0.1))) : null,
                  ),
                  child: Material(
                      ...
                      Row(
                        children: [
                          IconButton(
                            ...
                            icon:
                                Icon(Icons.chevron_left, color: _currentPage > 0 ? colors.textColor : colors.textMuted),
                          ),
                          Text(
