...
part of 'latest_openapi.swagger.dart';
...
final class _$LatestOpenapi extends LatestOpenapi {
  _$LatestOpenapi([ChopperClient? client]) {
    if (client == null) return;
    this.client = client;
  }

  @override
  final Type definitionType = LatestOpenapi;
