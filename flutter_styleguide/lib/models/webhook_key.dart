...
class WebhookKeyCreateRequest {
  ...
  const WebhookKeyCreateRequest({required this.name, this.description, this.expiresAt});

  Map<String, dynamic> toJson() {
    return {'name': name, 'description': description, 'expiresAt': expiresAt?.toIso8601String()};
  }
}
